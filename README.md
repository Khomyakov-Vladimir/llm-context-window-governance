...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18784361.svg)](https://doi.org/10.5281/zenodo.18784361)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

**Based on:** Khomyakov, V. (2026). *Phase-Aware Context Window Governance for Large Language Models: A CPL-Based Engineering Framework.*  
[doi:10.5281/zenodo.18784361](https://doi.org/10.5281/zenodo.18784361)
...
| `Ĥ_k` | Surrogate entropy (output-distribution Shannon entropy or mean attention entropy) |
...
See the [preprint](https://doi.org/10.5281/zenodo.18784361) for complete proofs and assumptions.
...
│     · Ĥ_k  (output entropy / attn entropy)   │
...
def get_cpl_phase(
    ...
    Args:
        entropy:       Surrogate behavioral entropy (Ĥ_k).
...
- **This framework:** Khomyakov, V. (2026). *Phase-Aware Context Window Governance for Large Language Models: A CPL-Based Engineering Framework (1.0).* Zenodo [https://doi.org/10.5281/zenodo.18784361](https://doi.org/10.5281/zenodo.18784361)

## Support for Independent Research

If this framework has been useful for your work — whether it informed an implementation, offered a new perspective on LLM stability, or contributed to your research — you can support its continued development. This work is conducted independently, without institutional funding; contributions help cover the computational costs and API access required for ongoing formal analysis and simulations.

**USDT (TRC20, TRON network):** `TDBLiry9BkDpUrfaXC7wh9oQQNUMniGvgf`
...
See the original publication for terms of use.
